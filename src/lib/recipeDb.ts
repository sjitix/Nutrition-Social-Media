...
const SEED_RECIPES: RecipeSeed[] = [
  ...
  {
    id: "b-vegan-protein-oats", name: "Peanut Protein Oats", type: "breakfast",
    cuisine: "american", mainProtein: "legumes",
    timeMinutes: 5, approxCost: 2,
    dietTags: ["vegan", "vegetarian"],
    description: "Oats whisked with protein powder and peanut butter.",
    ingredients: [
      { name: "rolled oats", quantity: "60 g" },
      { name: "protein powder", quantity: "1 scoop" },
      { name: "peanut butter", quantity: "1 tbsp" },
    ...
    steps: ["Cook the oats.", "Stir in protein powder, peanut butter and chia."],
  },
  {
  ...
  {
    id: "b-tofu-protein-smoothie", name: "Berry Tofu Protein Bowl", type: "breakfast",
    cuisine: "american", mainProtein: "tofu",
    timeMinutes: 5, approxCost: 2,
    dietTags: ["vegan", "vegetarian", "gluten_free"],
    description: "Silken tofu blended with protein powder and berries.",
    ingredients: [
      { name: "firm tofu", quantity: "180 g" },
      { name: "protein powder", quantity: "1 scoop" },
      { name: "mixed berries", quantity: "100 g" },
      { name: "chia seeds", quantity: "1 tsp" },
    ],
    steps: ["Blend the tofu, protein powder and half the berries.", "Top with the rest and the chia."],
  },
  {
