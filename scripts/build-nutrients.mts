...
if (process.argv.includes("--emit")) {
  ...
  const out = `// GENERATED by scripts/build-nutrients.mts from USDA FoodData Central SR Legacy.\n// Do not edit by hand. Every entry records the fdc_id it came from, so values are traceable.\nexport const NUTRIENT_TABLE = ${JSON.stringify(table, null, 2)} as const;\n`;
